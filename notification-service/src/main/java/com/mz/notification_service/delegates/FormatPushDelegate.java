...
@Component("formatPushDelegate")
public class FormatPushDelegate implements JavaDelegate {
    private static final Logger log = LoggerFactory.getLogger(FormatPushDelegate.class);

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        log.info("Formatting push notification");
        ...
        newEvent.put("activity", "FORMAT_PUSH");
